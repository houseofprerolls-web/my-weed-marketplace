    ...
    >
      <div
        className={
          isSheet
            ...
            : "flex min-w-[6.75rem] max-w-[11rem] flex-1 items-center gap-1 rounded-md border border-brand-red/30 bg-zinc-950/90 pl-1.5 sm:min-w-[7.25rem] sm:max-w-xs"
        }
      >
      ...
      >
        <Button
          ...
          className="h-8 border-brand-lime/40 px-2 text-xs text-brand-lime hover:bg-brand-lime/10 sm:h-9 sm:px-3 sm:text-sm"
        >
        ...
        <Button
          ...
          size="sm"
          onClick={applyZip}
          className="h-8 bg-brand-red px-2.5 text-xs hover:bg-brand-red-deep sm:h-9 sm:px-4 sm:text-sm"
        >
          Set
        </Button>
      </div>
