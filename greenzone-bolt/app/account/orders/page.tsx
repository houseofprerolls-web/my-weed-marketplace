...
export default function OrdersPage() {
    ...
    try {
      if (vendorsSchema) {
        const { data, error } = await supabase
          .from('orders')
          .select('id, vendor_id, order_number, status, total_cents, created_at, delivery_address, is_scheduled, scheduled_for')
        ...
        setOrders(
          rows.map((o) => ({
            ...
            is_scheduled: o.is_scheduled === true,
  ...
  const vendorsMode = vendorsSchema;
