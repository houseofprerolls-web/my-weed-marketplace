...
export default function VendorPricingPage() {
  ...
  if (!user) {
    return (
      <div className="flex min-h-screen flex-col bg-gray-50 md:flex-row">
        <VendorNav />
        <div className="container mx-auto max-w-4xl min-w-0 flex-1 px-4 py-16">
          <Alert>
  ...
  return (
    <div className="flex min-h-screen flex-col bg-gray-50 md:flex-row">
      ...
      <div className="container mx-auto min-w-0 flex-1 px-4 py-12">
        {/* Header */}
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Select the perfect plan to grow your cannabis delivery business on Da Treehouse
          </p>
        </div>
