...
export default function CheckoutPage() {
  ...
  const cartItems = [
    {
      ...
      price: 45.00,
      quantity: 1,
      image: SITE_IMAGE_SLOTS.checkoutSample1,
    },
    {
      id: '2',
      ...
      price: 12.00,
      quantity: 2,
      image: SITE_IMAGE_SLOTS.checkoutSample2,
    },
  ];
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Hub checkout copies ID from the user's profile (uploaded once).
    if (!profile?.id_document_url) {
      setError('Please upload your photo ID once in your profile before placing an order.');
      return;
    }
              ...
              <Card className="bg-gradient-to-br from-green-900/20 to-blue-900/20 border-green-600/30 p-6">
                <div className="flex items-start gap-4 mb-4">
                  ...
                  <div className="flex-1">
                    <h2 className="text-xl font-semibold mb-2">Identity Verification from Profile</h2>
                    <p className="text-gray-300 text-sm mb-4">
                      Upload your photo ID once in your profile. We attach it to your order for vendor verification.
                    </p>
                  </div>
                </div>
