...
export const metadata: Metadata = {
  title: 'Order & Refund Policy | Da Treehouse',
  description: 'Understanding order fulfillment and refund procedures on Da Treehouse',
};
  ...
  return (
    <div className="min-h-screen bg-black text-gray-200">
      <div className="container mx-auto px-4 py-16 max-w-4xl">
        <h1 className="text-4xl font-bold text-white mb-8">Order & Refund Policy</h1>
        ...
        <div className="prose prose-invert prose-lg max-w-none space-y-8 prose-headings:text-white prose-a:text-green-400">
          <section className="rounded-lg border border-blue-500/35 bg-blue-950/25 p-6 border-l-4 border-l-blue-500">
            <h2 className="text-xl font-bold text-white mb-3">Important notice</h2>
            <p className="text-gray-200 font-medium">
              Da Treehouse operates strictly as a directory and discovery platform. We connect customers with licensed cannabis vendors but do not process payments, hold inventory, or fulfill orders.
            </p>
          ...
          <section>
            ...
            <p className="text-gray-300 mb-4">
              Da Treehouse provides a marketplace platform where:
            </p>
            ...
            <p className="text-gray-300 mt-4 font-medium">
              Da Treehouse is NOT involved in the transaction process. We do not:
            </p>
          ...
          <section>
            ...
            <p className="text-gray-300 mb-4">
              When you place an order through Da Treehouse:
            </p>
            <ol className="list-decimal pl-6 space-y-3 text-gray-300">
              <li>
                <strong>Browse Products:</strong> You browse vendor listings and products on the Da Treehouse platform
              </li>
              <li>
            ...
            <p className="text-gray-300 mt-4 italic">
              Da Treehouse facilitates the connection but is not a party to the transaction.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-300 mb-4">
              Each vendor on Da Treehouse is an independent business responsible for:
            </p>
            <ul className="list-disc pl-6 space-y-2 text-gray-300">
          ...
          <section>
            ...
            <p className="text-gray-300 mb-4">
              Refund and return policies are set by individual vendors, not by Da Treehouse. Common vendor policies include:
            </p>

            <div className="space-y-4">
              <div className="rounded-lg border border-green-900/25 bg-gray-900/50 p-5">
                <h3 className="font-bold text-lg text-white mb-2">Typical refund scenarios</h3>
                <ul className="list-disc pl-6 space-y-2 text-gray-300">
              ...
              <div className="rounded-lg border border-green-900/25 bg-gray-900/50 p-5">
                <h3 className="font-bold text-lg text-white mb-2">Non-refundable situations</h3>
                <p className="text-gray-300 mb-2">Most vendors do not accept returns or provide refunds for:</p>
                <ul className="list-disc pl-6 space-y-2 text-gray-300">
          ...
          <section>
            ...
            <p className="text-gray-300 mt-4">
              Da Treehouse is not responsible for delivery delays or fulfillment issues, but vendors may face penalties for consistent delivery problems.
            </p>
          </section>
          ...
          <section>
            ...
            <ol className="list-decimal pl-6 space-y-3 text-gray-300">
              ...
              <li>
                <strong>Report to Da Treehouse:</strong> If unresolved, report the issue through our support system
              </li>
            </ol>

            <div className="bg-yellow-50 p-5 rounded-lg mt-4 border-l-4 border-yellow-600">
              <h3 className="font-bold mb-2">What Da Treehouse Can Do</h3>
              <p className="text-gray-300 mb-2">While we cannot process refunds directly, we can:</p>
              <ul className="list-disc pl-6 space-y-2 text-gray-300">
          ...
          <section>
            ...
            <p className="text-gray-300 mt-4">
              <strong>Payment Disputes:</strong> Contact your payment provider (bank, card issuer, payment app) and the vendor to resolve payment issues. Da Treehouse does not process or handle payments.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-300 mt-4">
              Contact the vendor immediately if you need to cancel an order. Cancellation requests through Da Treehouse cannot stop orders in progress.
            </p>
          </section>
          ...
          <section>
            ...
            <ol className="list-decimal pl-6 space-y-3 text-gray-300">
              ...
              <li>Report serious safety concerns to Da Treehouse and appropriate regulatory authorities</li>
            </ol>
            <p className="text-gray-300 mt-4">
              Da Treehouse takes product safety seriously. Vendors with repeated quality complaints may face account suspension.
            </p>
          </section>
          ...
          <section>
            ...
            <div className="rounded-lg border border-green-900/25 bg-gray-900/50 p-6">
              <p className="text-gray-300 font-medium">Da Treehouse customer support</p>
          ...
          <section className="mt-8 rounded-lg border border-green-900/30 bg-green-950/20 p-6">
            <h3 className="text-xl font-bold text-white mb-3">Your rights as a customer</h3>
            <p className="text-gray-300 mb-3">
              While Da Treehouse is not directly involved in transactions, we are committed to maintaining a safe, reliable marketplace. You have the right to:
            </p>
            <ul className="list-disc pl-6 space-y-2 text-gray-300">
