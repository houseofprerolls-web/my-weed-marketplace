-- Paste in Supabase SQL editor if migration 0034 was not applied.
-- Mirrors supabase/migrations/0034_vendor_lead_applications.sql
...
create table if not exists public.vendor_lead_applications (
  ...
  zip text not null,
  license_number text, -- state cannabis regulatory license number (LIC)
