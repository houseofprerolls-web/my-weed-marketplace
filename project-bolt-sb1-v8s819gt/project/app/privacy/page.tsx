...
export const metadata = {
  title: 'Privacy Policy | GreenZone',
  description: 'GreenZone Privacy Policy - How we collect, use, and protect your information',
};
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="prose prose-lg max-w-none space-y-8">
            <section>
              ...
              <p>
                GreenZone (&quot;we,&quot; &quot;our,&quot; or &quot;us&quot;) respects your privacy and is committed to protecting your personal information. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our cannabis marketplace platform.
              </p>
            </section>
            ...
            <section>
              ...
              <div className="bg-gray-50 p-4 rounded-lg mt-4">
                ...
                <p><strong>Mail:</strong> GreenZone Privacy Team, [Address]</p>
