...
export const metadata: Metadata = {
  title: "Vendor Agreement | Green Zone",
  description: "Terms and conditions for vendors operating on the Green Zone platform"
};
  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="container mx-auto px-4 py-16 max-w-4xl">
        <h1 className="text-4xl font-bold mb-8">Vendor Agreement</h1>
        ...
        <div className="prose prose-lg max-w-none space-y-8">
          <section>
            ...
            <p className="text-gray-700 mb-4">
              By registering as a vendor on the Green Zone platform ("Platform"), you agree to be bound by this Vendor Agreement ("Agreement"). This Agreement governs your use of the Platform and the services provided to facilitate your cannabis delivery business.
            </p>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 text-gray-700">
              ...
              <li>Provide proof of licensing upon request by Green Zone</li>
              <li>Immediately notify Green Zone of any license suspension, revocation, or expiration</li>
          ...
          <section>
            ...
            <p className="text-gray-700 mb-4">
              Green Zone operates strictly as a directory and discovery platform connecting cannabis vendors with customers. You acknowledge and agree that:
            </p>
            <ul className="list-disc pl-6 space-y-2 text-gray-700">
              <li>Green Zone does not process payments or handle transactions</li>
              <li>Green Zone does not hold, store, or distribute cannabis products</li>
              <li>All sales occur directly between vendor and customer</li>
              <li>Green Zone is not responsible for product quality, delivery, or customer disputes</li>
              <li>Green Zone does not verify product testing or compliance</li>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 text-gray-700">
              ...
              <li>Notify Green Zone of payment method changes or updates</li>
          ...
          <section>
            ...
            <p className="text-gray-700 mb-4">
              Green Zone reserves the right to suspend or terminate your vendor account at any time for violations of this Agreement, including but not limited to:
            </p>
            <ul className="list-disc pl-6 space-y-2 text-gray-700">
            ...
            <p className="text-gray-700 mt-4">
              Green Zone will make reasonable efforts to provide notice of suspension when possible, but reserves the right to immediately suspend accounts for serious violations.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700 mb-4">
              You agree to indemnify, defend, and hold harmless Green Zone and its officers, directors, employees, and agents from any claims, damages, losses, liabilities, and expenses (including attorney fees) arising from:
            </p>
            <ul className="list-disc pl-6 space-y-2 text-gray-700">
          ...
          <section>
            ...
            <p className="text-gray-700 mb-4">
              Green Zone collects data about vendor performance, customer interactions, and platform usage. You acknowledge that:
            </p>
            <ul className="list-disc pl-6 space-y-2 text-gray-700">
              <li>Green Zone owns all platform data and analytics</li>
              <li>Aggregated vendor data may be used for platform improvements</li>
              <li>Green Zone may display vendor ratings, reviews, and performance metrics</li>
          ...
          <section>
            ...
            <p className="text-gray-700 mb-4">
              You retain ownership of your business name, logo, product images, and content uploaded to the Platform. However, you grant Green Zone a non-exclusive license to display, reproduce, and distribute your content for the purpose of operating the Platform.
            </p>
            <p className="text-gray-700">
          ...
          <section>
            ...
            <p className="text-gray-700 mb-4">
              Green Zone reserves the right to modify this Agreement at any time. Material changes will be communicated to vendors via email and platform notifications. Continued use of the Platform after changes constitutes acceptance of the modified Agreement.
            </p>
          </section>
          ...
          <section>
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              <p className="text-gray-700 font-medium">Green Zone Vendor Support</p>
              <p className="text-gray-700">Email: vendors@greenzone.com</p>
              <p className="text-gray-700">Phone: 1-800-GREEN-ZONE</p>
            </div>
          </section>

          <section className="bg-green-50 p-6 rounded-lg mt-8">
            <h3 className="text-xl font-bold mb-3">Vendor Acknowledgment</h3>
            <p className="text-gray-700">
