      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <Card className="bg-gray-900 border-green-900/20 p-8 mb-12">
          ...
          <div className="prose prose-invert max-w-none text-gray-300 space-y-4">
            <p>
              Looking for cannabis delivery in {cityName}? GreenFinder connects you with the best licensed dispensaries offering fast, reliable weed delivery to your door. Browse from a wide selection of products including flower, edibles, vapes, pre-rolls, concentrates, and CBD products.
            </p>
            <p>
              All delivery services on GreenFinder are licensed and verified, ensuring you receive safe, high-quality cannabis products. Most services offer delivery within 30-60 minutes, making it easy and convenient to get what you need.
            </p>
        ...
        <Card className="bg-gray-900 border-green-900/20 p-8">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="text-gray-300">
                All delivery services listed on GreenFinder are licensed and operate legally within {cityName}. Always verify the service is licensed before placing an order.
              </p>
            </div>
            <div>
              <h3 className="text-lg font-semibold text-white mb-2">
