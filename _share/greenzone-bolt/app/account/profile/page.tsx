  ...
  async function handleIdFileChange(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    try {
      ...
      const { error } = await supabase
        .from('profiles')
        .update({
          id_document_url: res.url,
          id_document_type: idDocType,
          id_document_uploaded_at: new Date().toISOString(),
          // Start unverified; vendors see the document in each order.
          id_verified: false,
        })
        .eq('id', user.id);
          ...
          <form onSubmit={handleSave} className="space-y-5">
            <div>
              ...
              <Input
                ...
                className="mt-1 border-green-900/30 bg-black text-white"
            ...
            <div>
              ...
              <Textarea
                ...
                className="mt-1 min-h-[100px] border-green-900/30 bg-black text-white"
