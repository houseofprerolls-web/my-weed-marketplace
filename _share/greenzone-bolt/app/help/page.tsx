...
export const metadata = {
  title: 'Help Center | DaTreehouse',
  description: 'Get help and find answers to common questions about DaTreehouse',
};
        ...
        <div className="bg-gradient-to-b from-green-50 to-white py-12">
          <div className="max-w-4xl mx-auto px-4 text-center">
            ...
            <p className="text-gray-600 mb-8">
              Find answers to common questions and learn how to use DaTreehouse
            </p>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <Accordion type="single" collapsible className="space-y-4">
            ...
            <AccordionItem value="item-10">
              <AccordionTrigger className="text-left">
                How do I become a vendor on DaTreehouse?
              </AccordionTrigger>
              <AccordionContent>
