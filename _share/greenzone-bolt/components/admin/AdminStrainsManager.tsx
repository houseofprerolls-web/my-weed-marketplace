            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              <label className="flex items-center gap-2 text-gray-400">
                ...
                <Input
                  ...
                  disabled={loading}
                  className="h-8 w-16 border-green-900/40 bg-black px-2 text-center text-sm text-white [appearance:textfield] [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none"
          ...
          <div className="space-y-3 py-2">
            <div>
              ...
              <Input
                ...
                className="mt-1 border-green-900/40 bg-black text-white"
                onBlur={() => {
            ...
            <div>
              ...
              <Input
                ...
                className="mt-1 border-green-900/40 bg-black font-mono text-sm text-white"
              />
            </div>
            <div>
              <Label>Type</Label>
              <Select value={form.type} onValueChange={(v) => setForm((f) => ({ ...f, type: v }))}>
                <SelectTrigger className="mt-1 border-green-900/40 bg-black text-white">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
            ...
            <div>
              ...
              <Textarea
                ...
                rows={6}
                className="border-green-900/40 bg-black text-white"
              />
            </div>
          </div>
          <DialogFooter>
