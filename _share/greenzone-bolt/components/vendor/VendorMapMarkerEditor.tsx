    ...
    return (
      <Card className="border-amber-900/30 bg-gradient-to-br from-gray-900 to-black p-8 text-center">
        ...
        <p className="mt-3 text-sm text-gray-400">
          A platform administrator must turn on at least one region for your store under{' '}
          <span className="text-gray-200">Admin → Vendors → your store → operating areas / markets</span>. Until then, map
          ...
          <div className="h-[min(520px,70vh)] w-full min-h-[360px]">
            ...
            >
              ...
              <Marker
                ...
                onDragEnd={onDragEnd}
              >
                <div className="flex h-12 w-12 cursor-grab items-center justify-center rounded-full border-[3px] border-green-400 bg-gray-900 text-lg font-bold text-green-400 shadow-lg active:cursor-grabbing">
